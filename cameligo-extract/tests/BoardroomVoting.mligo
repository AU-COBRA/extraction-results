...
let handle_signup (pk : a) (prf : (a * int)) (state : state) (caller : address) (cur_slot : nat) (chain : chain) (ctx : cctx) (state0 : state) (msg : msg option) (acts : operation list) : (((((chain * cctx) * state) * msg option) * operation list) * state option) = 
match (((((chain, ctx), state0), msg), acts), (if ltbN state.setup.finish_registration_by cur_slot then (None:unit option) else Some ())) with 
...
Some res1 -> (match (((((ctx0, chain0), p20), p10), p00), (match Map.find_opt caller state.setup.eligible_voters with 
Some a -> (Some ())
...
Some res3 -> (match (((((ctx1, chain1), p21), p11), p01), (match Map.find_opt caller state.registered_voters with 
...
Some res5 -> (match match ((ctx2, chain2), (ctx_amount chain2)) with 
 (res6, p5) -> (match res6 with 
 (ctx3, chain3) -> (((((ctx3, chain3), p22), p12), p02), (Some p5))) with 
 (res6, p5) -> (match res6 with 
 (acts3, p03) -> (match acts3 with 
 (msg3, p13) -> (match msg3 with 
 (state4, p23) -> (match state4 with 
 (ctx3, chain3) -> (match p5 with 
Some res7 -> (match (((((ctx3, chain3), p23), p13), p03), (if eqTez res7 state.setup.registration_deposit then Some () else (None:unit option))) with 
...
Some res9 -> (match (((((ctx4, chain4), p24), p14), p04), (if ltInt (int (List.length state.public_keys)) (subInt order 2) then Some () else (None:unit option))) with 
...
Some res11 -> ((let index = List.length state.public_keys in 
...
Some res13 -> ((let inf = ({voter_index = index; vote_hash = 1n; public_vote = 0}: voterInfo) in 
...
fun (chain8 : chain) -> fun (ctx8 : cctx) -> fun (state9 : state) -> fun (msg8 : msg option) -> fun (acts8 : operation list) -> (((((chain8, ctx8), state9), msg8), acts8), (Some new_state))) ctx7 chain7 p26 p16 p06)
 | None  -> (((((ctx7, chain7), p26), p16), p06), (None:state option)))))))) ctx5 chain5 p25 p15 p05)
 | None  -> (((((ctx5, chain5), p25), p15), p05), (None:state option))))))))
 | None  -> (((((ctx4, chain4), p24), p14), p04), (None:state option))))))))
 | None  -> (((((ctx3, chain3), p23), p13), p03), (None:state option))))))))
 | None  -> (((((ctx2, chain2), p22), p12), p02), (None:state option))))))))
 | None  -> (((((ctx1, chain1), p21), p11), p01), (None:state option))))))))
 | None  -> (((((ctx0, chain0), p20), p10), p00), (None:state option)))))))
...
let handle_commit_to_vote (hash_ : nat) (state : state) (caller : address) (cur_slot : nat) (chain : chain) (ctx : cctx) (state0 : state) (msg : msg option) (acts : operation list) : (((((chain * cctx) * state) * msg option) * operation list) * state option) = 
match (((((chain, ctx), state0), msg), acts), state.setup.finish_commit_by) with 
 (res0, p0) -> (match res0 with 
 (acts0, p00) -> (match acts0 with 
 (msg0, p10) -> (match msg0 with 
 (state1, p20) -> (match state1 with 
 (ctx0, chain0) -> (match p0 with 
Some res1 -> (match (((((ctx0, chain0), p20), p10), p00), (if ltbN res1 cur_slot then (None:unit option) else Some ())) with 
 (res2, p3) -> (match res2 with 
 (acts1, p01) -> (match acts1 with 
 (msg1, p11) -> (match msg1 with 
 (state2, p21) -> (match state2 with 
 (ctx1, chain1) -> (match p3 with 
Some res3 -> (match (((((ctx1, chain1), p21), p11), p01), (Map.find_opt caller state.registered_voters)) with 
 (res4, p4) -> (match res4 with 
 (acts2, p02) -> (match acts2 with 
 (msg2, p12) -> (match msg2 with 
 (state3, p22) -> (match state3 with 
 (ctx2, chain2) -> (match p4 with 
Some res5 -> ((let inf = set_VoterInfo_vote_hash (fun (a : nat) -> hash_) res5 in 
fun (chain3 : chain) -> fun (ctx3 : cctx) -> fun (state4 : state) -> fun (msg3 : msg option) -> fun (acts3 : operation list) -> (((((chain3, ctx3), state4), msg3), acts3), (Some (set_State_registered_voters (Map.add caller inf) state)))) ctx2 chain2 p22 p12 p02)
 | None  -> (((((ctx2, chain2), p22), p12), p02), (None:state option))))))))
 | None  -> (((((ctx1, chain1), p21), p11), p01), (None:state option))))))))
 | None  -> (((((ctx0, chain0), p20), p10), p00), (None:state option)))))))
...
let handle_submit_vote (v : a) (proof : voteProof) (state : state) (caller : address) (cur_slot : nat) (chain : chain) (ctx : cctx) (state0 : state) (msg : msg option) (acts : operation list) : (((((chain * cctx) * state) * msg option) * operation list) * state option) = 
match (((((chain, ctx), state0), msg), acts), (if ltbN state.setup.finish_vote_by cur_slot then (None:unit option) else Some ())) with 
 (res0, p0) -> (match res0 with 
 (acts0, p00) -> (match acts0 with 
 (msg0, p10) -> (match msg0 with 
 (state1, p20) -> (match state1 with 
 (ctx0, chain0) -> (match p0 with 
Some res1 -> (match (((((ctx0, chain0), p20), p10), p00), (Map.find_opt caller state.registered_voters)) with 
 (res2, p3) -> (match res2 with 
 (acts1, p01) -> (match acts1 with 
 (msg1, p11) -> (match msg1 with 
 (state2, p21) -> (match state2 with 
 (ctx1, chain1) -> (match p3 with 
Some res3 -> (match (((((ctx1, chain1), p21), p11), p01), (match state.setup.finish_commit_by with 
Some a -> (if eqN (hash_func ((unsafe_int_to_nat v) :: ([]:nat list))) res3.vote_hash then Some () else (None:unit option))
 | None  -> (Some ()))) with 
 (res4, p4) -> (match res4 with 
 (acts2, p02) -> (match acts2 with 
 (msg2, p12) -> (match msg2 with 
 (state3, p22) -> (match state3 with 
 (ctx2, chain2) -> (match p4 with 
Some res5 -> (match (((((ctx2, chain2), p22), p12), p02), (if verify_secret_vote_proof (nth res3.voter_index state.public_keys 0) (reconstructed_key state.public_keys res3.voter_index) v res3.voter_index proof then Some () else (None:unit option))) with 
 (res6, p5) -> (match res6 with 
 (acts3, p03) -> (match acts3 with 
 (msg3, p13) -> (match msg3 with 
 (state4, p23) -> (match state4 with 
 (ctx3, chain3) -> (match p5 with 
Some res7 -> ((let inf = set_VoterInfo_public_vote (fun (a : a) -> v) res3 in 
fun (chain4 : chain) -> fun (ctx4 : cctx) -> fun (state5 : state) -> fun (msg4 : msg option) -> fun (acts4 : operation list) -> (((((chain4, ctx4), state5), msg4), acts4), (Some (set_State_registered_voters (Map.add caller inf) state)))) ctx3 chain3 p23 p13 p03)
 | None  -> (((((ctx3, chain3), p23), p13), p03), (None:state option))))))))
 | None  -> (((((ctx2, chain2), p22), p12), p02), (None:state option))))))))
 | None  -> (((((ctx1, chain1), p21), p11), p01), (None:state option))))))))
 | None  -> (((((ctx0, chain0), p20), p10), p00), (None:state option)))))))
...
let handle_tally_votes (state : state) (cur_slot : nat) (chain : chain) (ctx : cctx) (state0 : state) (msg : msg option) (acts : operation list) : (((((chain * cctx) * state) * msg option) * operation list) * state option) = 
match (((((chain, ctx), state0), msg), acts), (if ltbN cur_slot state.setup.finish_vote_by then (None:unit option) else Some ())) with 
 (res0, p0) -> (match res0 with 
 (acts0, p00) -> (match acts0 with 
 (msg0, p10) -> (match msg0 with 
 (state1, p20) -> (match state1 with 
 (ctx0, chain0) -> (match p0 with 
Some res1 -> (match (((((ctx0, chain0), p20), p10), p00), (match state.tally with 
Some n0 -> (None:unit option)
 | None  -> (Some ()))) with 
 (res2, p3) -> (match res2 with 
 (acts1, p01) -> (match acts1 with 
 (msg1, p11) -> (match msg1 with 
 (state2, p21) -> (match state2 with 
 (ctx1, chain1) -> (match p3 with 
Some res3 -> ((let voters = (fun (v:(address, voterInfo) map) ->
...
Some res5 -> ((let votes = List.map public_vote voters in 
...
Some res7 -> (((((ctx5, chain5), p23), p13), p03), (Some (set_State_tally (fun (a : nat option) -> Some res7) state)))
 | None  -> (((((ctx5, chain5), p23), p13), p03), (None:state option)))))))) ctx3 chain3 p22 p12 p02)
 | None  -> (((((ctx3, chain3), p22), p12), p02), (None:state option)))))))) ctx1 chain1 p21 p11 p01)
 | None  -> (((((ctx1, chain1), p21), p11), p01), (None:state option))))))))
 | None  -> (((((ctx0, chain0), p20), p10), p00), (None:state option)))))))

let receive (chain : chain) (ctx : cctx) (state : state) (msg : msg option) (acts : operation list) : (((((chain * cctx) * state) * msg option) * operation list) * state option) = 
match (((((chain, ctx), state), msg), acts), (Some state)) with 
 (res0, p0) -> (match res0 with 
 (acts0, p00) -> (match acts0 with 
 (msg0, p10) -> (match msg0 with 
 (state0, p20) -> (match state0 with 
 (ctx0, chain0) -> (match p0 with 
Some res1 -> (match match ((ctx0, chain0), (ctx_from chain0)) with 
 (res2, p3) -> (match res2 with 
 (ctx1, chain1) -> (((((ctx1, chain1), p20), p10), p00), (Some p3))) with 
 (res2, p3) -> (match res2 with 
 (acts1, p01) -> (match acts1 with 
 (msg1, p11) -> (match msg1 with 
 (state1, p21) -> (match state1 with 
 (ctx1, chain1) -> (match p3 with 
Some res3 -> (match match ((ctx1, chain1), (current_slot ctx1)) with 
 (res4, p4) -> (match res4 with 
 (ctx2, chain2) -> (((((ctx2, chain2), p21), p11), p01), (Some p4))) with 
 (res4, p4) -> (match res4 with 
 (acts2, p02) -> (match acts2 with 
 (msg2, p12) -> (match msg2 with 
 (state2, p22) -> (match state2 with 
 (ctx2, chain2) -> (match p4 with 
Some res5 -> (match match (((((ctx2, chain2), p22), p12), p02), (Some p12)) with 
 (res6, p5) -> (match res6 with 
 (acts3, p03) -> (match acts3 with 
 (msg3, p13) -> (match msg3 with 
 (state3, p23) -> (match state3 with 
 (ctx3, chain3) -> (match p5 with 
Some res7 -> (((((ctx3, chain3), p23), p13), p03), res7)
 | None  -> (((((ctx3, chain3), p23), p13), p03), (None:msg option))))))) with 
 (res6, p5) -> (match res6 with 
 (acts3, p03) -> (match acts3 with 
 (msg3, p13) -> (match msg3 with 
 (state3, p23) -> (match state3 with 
 (ctx3, chain3) -> (match p5 with 
Some res7 -> ((match res7 with 
...
let receive_wrapper (c : chain) (ctx : cctx) (st : state) (msg : msg option) : (operation list * state) option = 
...
Some p0 -> (match p0 with 
 (acts0, st0) -> (Some (st0, acts0)))
 | None  -> (None:(operation list * state) option)

let init (s : (address * setup)) : state = let inner (s : (address * setup)) :state option = 
if ltbN s.1.finish_registration_by s.1.finish_vote_by then Some ({owner = s.0; registered_voters = (Map.empty: (address, voterInfo) map); public_keys = ([]:a list); setup = s.1; tally = (None:nat option)}: state) else (None:state option) in
match (inner s) with
  Some v -> v
