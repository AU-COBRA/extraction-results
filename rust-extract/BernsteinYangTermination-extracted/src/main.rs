...
fn ConCert_Extraction_BernsteinYangTermination_shiftr(&'a self, a: i64, b: i64) -> i64 { a >> b }
fn ConCert_Extraction_BernsteinYangTermination_shiftr__curried(&'a self) -> &'a dyn Fn(i64) -> &'a dyn Fn(i64) -> i64 {
  self.closure(move |a| {
    self.closure(move |b| {
      self.ConCert_Extraction_BernsteinYangTermination_shiftr(
        a,
        b)
    })
  })
...
fn ConCert_Extraction_BernsteinYangTermination_divstep(&'a self, d: i64, f: i64, g: i64) -> __pair<__pair<i64, i64>, i64> {
  match __andb!(
          self.Coq_ZArith_BinIntDef_Z_ltb(
            0,
            d),
      ...
      __mk_pair(
        ...
        self.ConCert_Extraction_BernsteinYangTermination_shiftr(
          self.Coq_ZArith_BinIntDef_Z_add(
            g,
            self.Coq_ZArith_BinIntDef_Z_mul(
              match self.Coq_ZArith_BinIntDef_Z_odd(
                      g) {
                true => {
                  __Z_frompos(
                    1)
...
fn ConCert_Extraction_BernsteinYangTermination_divstep__curried(&'a self) -> &'a dyn Fn(i64) -> &'a dyn Fn(i64) -> &'a dyn Fn(i64) -> __pair<__pair<i64, i64>, i64> {
  self.closure(move |d| {
    self.closure(move |f| {
      self.closure(move |g| {
        self.ConCert_Extraction_BernsteinYangTermination_divstep(
          d,
          f,
          g)
      })
...
fn ConCert_Extraction_BernsteinYangTermination_needs_n_steps(&'a self, d: i64, a: i64, b: i64, n: u64) -> bool {
  __nat_elim!(
    {
      true
    },
        ...
        false => {
          __pair_elim!(
            b2, p, {
              __pair_elim!(
                a2, d2, {
                  self.ConCert_Extraction_BernsteinYangTermination_needs_n_steps(
                    a2,
                    d2,
                    p,
                    n2)
...
fn ConCert_Extraction_BernsteinYangTermination_needs_n_steps__curried(&'a self) -> &'a dyn Fn(i64) -> &'a dyn Fn(i64) -> &'a dyn Fn(i64) -> &'a dyn Fn(u64) -> bool {
  self.closure(move |d| {
    self.closure(move |a| {
      self.closure(move |b| {
        self.closure(move |n| {
...
fn ConCert_Extraction_BernsteinYangTermination_min_needs_n_steps_nat(&'a self, a: i64, b: i64, n: u64, acc: i64, fuel: u64) -> i64 {
  __nat_elim!(
    {
      0
    },
      ...
      match self.Coq_ZArith_BinIntDef_Z_ltb(
        ...
        false => {
          ...
          match self.Coq_ZArith_BinIntDef_Z_ltb(
                  ...
                  length) {
            true => {
              self.ConCert_Extraction_BernsteinYangTermination_min_needs_n_steps_nat(
                self.Coq_ZArith_BinIntDef_Z_add(
                  a,
                  __Z_frompos(
                    __pos_zerobit(
...
fn ConCert_Extraction_BernsteinYangTermination_min_needs_n_steps_nat__curried(&'a self) -> &'a dyn Fn(i64) -> &'a dyn Fn(i64) -> &'a dyn Fn(u64) -> &'a dyn Fn(i64) -> &'a dyn Fn(u64) -> i64 {
  self.closure(move |a| {
    self.closure(move |b| {
      self.closure(move |n| {
...
fn ConCert_Extraction_BernsteinYangTermination_shiftl(&'a self, a: i64, b: i64) -> i64 { a << b }
fn ConCert_Extraction_BernsteinYangTermination_shiftl__curried(&'a self) -> &'a dyn Fn(i64) -> &'a dyn Fn(i64) -> i64 {
  self.closure(move |a| {
    self.closure(move |b| {
      self.ConCert_Extraction_BernsteinYangTermination_shiftl(
        a,
        b)
    })
  })
...
fn ConCert_Extraction_BernsteinYangTermination_nat_shiftl(&'a self, a: u64, b: u64) -> u64 { a << b }
fn ConCert_Extraction_BernsteinYangTermination_nat_shiftl__curried(&'a self) -> &'a dyn Fn(u64) -> &'a dyn Fn(u64) -> u64 {
  self.closure(move |a| {
    self.closure(move |n| {
      self.ConCert_Extraction_BernsteinYangTermination_nat_shiftl(
        a,
        n)
    })
  })
...
fn ConCert_Extraction_BernsteinYangTermination_W(&'a self, n: u64) -> i64 {
  self.ConCert_Extraction_BernsteinYangTermination_min_needs_n_steps_nat(
    __Z_frompos(
      1),
    0,
...
fn ConCert_Extraction_BernsteinYangTermination_W__curried(&'a self) -> &'a dyn Fn(u64) -> i64 {
  self.closure(move |n| {
    self.ConCert_Extraction_BernsteinYangTermination_W(
      n)
  })
}
}
